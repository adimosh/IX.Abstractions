...
namespace IX.System.IO
{
    ...
    public interface IFile
    {
        ...
        [NotNull]
        StreamWriter AppendText([NotNull] string path);
        ...
        /// <returns>A <see cref="T:System.IO.StreamWriter" /> that can write to a file.</returns>
        [NotNull]
        StreamWriter CreateText([NotNull] string path);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>
        ///     A task representing the current operation, holding a <see cref="T:System.DateTime" /> in UTC.
        /// </returns>
        [NotNull]
        ...
        [NotNull]
        Stream OpenWrite([NotNull] string path);
